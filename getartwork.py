        ...
        try:
            ...
            if search_type == "album":
                ...
                if matched:
                    ...
                    print(f"⚠️ {name} のアルバムアートワークが見つかりませんでした（アーティスト一致なし）。")
                    continue
                ...
                matched_track = find_matching_item(result["tracks"]["items"], cleaned_artist)
            ...
            print(f"✅ {name}（{album_name}）のアートワークを取得しました: {image_path}")
